...
class TestDataSummary(unittest.TestCase):
    def test_parse_completed_task_status(self):
        ...
        self.assertEqual(task_status.destinations, [TaskDestination(name='MB_B1_Part_A_Entry', compartment=None, action='dropoff')])
